...
def scan_voucher_final(img, active_cols, num_rows):
    # ၁။ ပုံကို OCR ဖတ်ရ ပိုကောင်းအောင် ပြုပြင်ခြင်း
    gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
    # Contrast မြှင့်တင်ပြီး စာလုံးများကို ပိုမိုထင်ရှားစေသည်
    gray = cv2.threshold(gray, 0, 255, cv2.THRESH_BINARY + cv2.THRESH_OTSU)[1]
    h, w = gray.shape

    # ၂။ OCR ဖတ်ခြင်း (ဂဏန်းနှင့် သင်္ကေတများသာ)
    ...
    # ၈ တိုင်အတွက် နေရာကို ပိုမိုတိကျစွာ ခွဲဝေခြင်း
    ...
    # ၃။ DITTO LOGIC (အပေါ်ကတန်ဖိုးကို အလိုအလျောက် ဖြည့်ခြင်း)
